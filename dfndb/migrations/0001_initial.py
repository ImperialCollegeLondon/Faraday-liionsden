    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mass', models.FloatField(default=0, help_text='optional molar mass', validators=[django.core.validators.MinValueValidator(0, 'Mass cannot be negative!')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('composition', models.ManyToManyField(help_text='e.g. NMC 622 would have 3 Compounds, Nickel 6, Manganese 2, Cobalt 2', through='dfndb.CompositionPart', to='dfndb.Compound')),
                ('user_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
