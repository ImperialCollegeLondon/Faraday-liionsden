    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='battDB.devicetype')),
        ...
        migrations.AddField(
            ...
            name='devices',
            field=models.ManyToManyField(through='battDB.DeviceConfigNode', to='battDB.DeviceType'),
        ),
        migrations.AddField(
            model_name='deviceconfig',
            name='user_owner',
