    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="This specifies an abstract device, e.g. 'Cell' with child members such as'Positive Electrode, Negative Electrode, Electrolyte etc. <BR>If this is set to True, then all metadata declared here must be overridden in child classes. An abstract specification cannot be used to define a physical device or batch.",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Device type. e.g. Cell, Module, Battery Pack. <BR>An abstract specification cannot have a device type - they define the device types.",
                ...
                (
                    ...
                    models.ManyToManyField(
                        through="battDB.DeviceParameter", to="dfndb.Parameter"
                    ),
                ),
                (
                    "parent",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="battDB.DeviceConfigNode", to="battDB.DeviceSpecification"
            ),
        ),
        migrations.AddField(
            model_name="deviceconfig",
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name_plural": "Data Ranges",},
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="datacolumn", unique_together={("device", "data", "batch_id")},
        ),
        migrations.CreateModel(
            name="BatchDevice",
            fields=[
