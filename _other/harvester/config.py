...
class HarvesterConfig:
    ...
    class FolderConfig:
        ...
        file_patterns: tuple = (
            "*",
        )  # List of file extensions / patterns to look for (TODO)
        parser: str = "autodetect"  # use a specific parser (TODO) choices will be: autodetect, biologic, ivium, maccor, neware..
        columns: tuple = (
            (
                "I/mA",
                "Current",
            ),  # List of columns in ('file header', 'human-readable name') format (TODO)
            ("V/mV", "Voltage"),
        )
    ...
    class MyBiologicFolderConfig(FolderConfig):
        ...
        file_patterns: tuple = (
            ...
            ".tsv",
            ".mpt",
        )  # specify file extensions per-folder (TODO)
        columns: tuple = (
            ("I/mA", "Current"),
            ("ECell/V", "Voltage"),
        )
    ...
    file_patterns: tuple = (
        ...
        ".mpt",
        ".txt",
    )  # specify file extensions (lower case)
