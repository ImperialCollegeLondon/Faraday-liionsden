...
18	2020-11-02 10:59:35.647447+00	2020-11-02 10:59:35.647505+00	uploaded_files/BioLogic_full.txt	abf6e42283668f8ba9094a0f85411f64
\.
...
SELECT pg_catalog.setval('public."battDB_experimentdatafile_id_seq"', 8, true);
...
SELECT pg_catalog.setval('public.common_uploadedfile_id_seq', 18, true);
...
--
-- Name: battDB_experimentdatafile battDB_experimentdat_use_parser_id_fffb2715_fk_battDB_da; Type: FK CONSTRAINT; Schema: public; Owner: towen
--

ALTER TABLE ONLY public."battDB_experimentdatafile"
    ADD CONSTRAINT "battDB_experimentdat_use_parser_id_fffb2715_fk_battDB_da" FOREIGN KEY (use_parser_id) REFERENCES public."battDB_dataparser"(id) DEFERRABLE INITIALLY DEFERRED;
