...
COPY public."battDB_experimentdatafile" (id, status, created_on, modified_on, attributes, notes, slug, raw_data_file_id, parsed_data, experiment_id, user_owner_id, use_parser_id, parsed_metadata, machine_id) FROM stdin;
\.
