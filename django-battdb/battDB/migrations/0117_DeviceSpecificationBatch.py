    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devType', models.CharField(choices=[('component', 'Component part of a cell'), ('cell', 'Single cell'), ('module', 'Module containing cells'), ('battery', 'Battery pack containing modules'), ('sensor', 'Sensor attached to a device'), ('cycler', 'Cycler Machine')], default='cell', max_length=16)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='specification',
            field=models.ForeignKey(blank=True, help_text='Copy metadata from another device?', limit_choices_to={'inherit_metadata': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='battDB.devicespecification'),
        ),
        migrations.AddField(
            model_name='devicebatch',
            name='user_owner',
        ...
        migrations.AlterField(
            ...
            name='device',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='used_in', to='battDB.devicespecification'),
        ),
        migrations.AlterField(
            model_name='experimentdatafile',
            name='mappings',
            field=models.ManyToManyField(blank=True, related_name='data_files', through='battDB.DataColumn', to='battDB.DeviceBatch'),
        ),
        migrations.DeleteModel(
            name='Device',
        ),
