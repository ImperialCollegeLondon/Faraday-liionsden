    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(help_text='Related device specification e.g. cell or sensor. Must have is_template=True', limit_choices_to={'inherit_metadata': True}, on_delete=django.db.models.deletion.CASCADE, to='battDB.devicespecification')),
