...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='analysis',
            field=models.JSONField(blank=True, default=battDB.models.experimentAnalysis_schema),
        ),
        migrations.AlterField(
            model_name='datarange',
            name='events',
        ...
        migrations.AlterField(
            ...
            name='attributes',
            field=models.JSONField(blank=True, default=battDB.models.equipmentType_schema),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='experiment',
            name='parameters',
            field=models.JSONField(blank=True, default=battDB.models.experimentParameters_schema),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='experimentdatafile',
            name='metadata',
            field=models.JSONField(blank=True, default=battDB.models.resultMetadata_schema),
        ),
        migrations.AlterField(
            model_name='experimentdatafile',
            name='parameters',
